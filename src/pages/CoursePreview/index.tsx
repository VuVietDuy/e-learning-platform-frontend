    ...
    <div className='coursepreview'>
      <div className="course__slider">
            <div className="slider-contain">
              <div className="slider-title">Dynamic Male Anatomy for Artists in Mudbox: Make realistic 3D Meta Human</div>
              <div className="slider-des">Learn to create robots like hard surface design character with Zbrush and Keyshot.</div>
              <div className="slider-rate">
                <div className="slider-rate-icon"></div>
                <div className="slider-rate-content">
                  <div className="slider-rate-content-rating">(100,558 ratings)</div>
                  <div className="slider-rate-content-vol">10,288 students</div>
                </div>
              </div>
              <div className="slider-link">
                <div className="slider-link-created">Created by</div>
                <a href="" className="slider-link-nuke">Nuke Family Packages</a>
              </div>
              <div className="slider-date">
                ...
                <div className="slider-date-language">icon English </div>
                <div className="slider-date-country">icon English, French, Chinese [Auto]</div>
              </div>
            </div>
      </div>
      <div className="course__content">
                ...
                <div className="course__1-pay">
                        ...
                        <div className="pay-price-cash">
                          <div className="pay-price-origin">
                            ...
                            <div className="pay-price-time">
                              ...
                              <div className="pay-price-time-hour">5 hours</div>
                              <div className="pay-price-time-left">left at this price!</div>
                            </div>
                        </div>
                        <button className="pay-price-btn">Add to cart</button>
                      </div>
                     ...
                     <div className="pay-course">
                      ...
                      <ul className="pay-course-list">
                        <li className="pay-course-item">12 hours on-demand video</li>
                        <li className="pay-course-item">55 downloadable resources</li>
                        <li className="pay-course-item">Full lifetime access</li>
                      </ul>
                     </div>
                     <div className="pay-coupon">
                      <div className="pay-apply-coupon">Apply Coupon</div>
                      <div className="pay-coupon-btn">
                        <input type="text" placeholder='HKML ABGF LOKI'  className="pay-coupon-input" />
            ...
            <div className="course__2">
                <div className="course-title">
                     ...
                     <div className="course-title-info">5 course rating  100K ratings</div>
                </div>
                <div className="course__2-list">
                    <Comment name="Duy" time="a week ago" content="Amet minim mollit non deserunt."></Comment>
                    <Comment name="Duy" time="a week ago" content="Amet minim mollit non deserunt."></Comment>
                    <Comment name="Duy" time="a week ago" content="Amet minim mollit non deserunt."></Comment>
                    <Comment name="Duy" time="a week ago" content="Amet minim mollit non deserunt. Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit."></Comment>
                    <div className="course__2-item">
                      <div className="course__2-item-name">
                          <div className="course__2-item-name-img">anh name</div>
                          <div className="item-name">
                              <div className="item-name-1">Bacon D.</div>
                                  <div className="item-name-rate">a week ago</div>
                              </div>
                          <div className="course__2-item-name-more"> More</div>
                      </div>
                      <div className="course__2-item-des">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet...</div>
