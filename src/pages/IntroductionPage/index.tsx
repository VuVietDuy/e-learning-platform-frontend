            ...
            <div className="Body">
                <div className="part1">
                    ...
                    <div className="login-pic">
                        <Routes>
                            <Route path='login' element={<LoginForm title="Start learning now" haveForgotPassword={true} haveNavSignup={true}></LoginForm>}></Route>
                ...
                <div className="part4">
                    ...
                    <div className="word-pic">
                        <div className="word">
                            ...
                            <br /><br />
                            <Button className="getStarted" size='32'>Get Started For Free</Button>
                        </div>
